/**
 * API: Call from the parent window
 */

function onXgenInit(bind, value) {
  console.log("Component init", bind, value);
}

function onXgenChange(bind, value) {
  console.log("Xgen value changed", bind, value);
}
